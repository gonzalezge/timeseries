...
###### ----- Definir path ------ ####
path <- gsub(rstudioapi::getActiveDocumentContext()$path,pattern = "/Clase 4.R",replacement = "")
setwd(path)
...
####### --------- Paso 2: Frontera Eficiente con dos activos ---------- ###### 
### Construir frontera eficiente solo con Exito y Ecopetrol
...
mediasHist*100
sdHist*100
##entonces invertir todo en exito es el portafolio de minima varianza y todo en ecopetrol
##el de maxima rentabilidad
##combinanciones convexas entre estos dos mapean toda la frontera
...
#### Deben seleccionar los comandos: 
#### - 1: Plot Efficient Frontier: Grafica la frontera eficiente
#### - 1: Add Minimum Risk Portfolio: Grafica el optimo 

######### --------- Resultado optimo ------- ######### 
efPortfolio_historico<- efficientPortfolio(as.timeSeries(ret_exito_ecopetrol),espFrontera,constraints)


####### --------- Paso 3: Frontera Eficiente con dos activos y pronostico---------- ###### 
## se quiere hacer el mismo ejercicio que en la seccion anterior pero mejorando el retorno esperado
## y la volatilidad esperada con ayuda de modelos arima y garch
...
#ahora tenemos una nueva distribucion para nuestros precios, hacemos el mismo ejercicio
